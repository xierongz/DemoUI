...
void Charge2Activity::onTextChanged(ZKTextView *pTextView, const std::string &text) {
...
void Charge2Activity::rigesterActivityTimer() {
...
void Charge2Activity::onVideoPlayerMessage(ZKVideoView *pVideoView, int msg) {
...
void Charge2Activity::videoLoopPlayback(ZKVideoView *pVideoView, int msg, int callbackTabIndex) {
...
void Charge2Activity::startVideoLoopPlayback() {
    int tablen = sizeof(SVideoViewCallbackTab) / sizeof(S_VideoViewCallback);
    for (int i = 0; i < tablen; ++i) {
    	if (SVideoViewCallbackTab[i].loop) {
...
void Charge2Activity::stopVideoLoopPlayback() {
    int tablen = sizeof(SVideoViewCallbackTab) / sizeof(S_VideoViewCallback);
    for (int i = 0; i < tablen; ++i) {
    	if (SVideoViewCallbackTab[i].loop) {
    		ZKVideoView* videoView = (ZKVideoView*)findControlByID(SVideoViewCallbackTab[i].id);
...
bool Charge2Activity::parseVideoFileList(const char *pFileListPath, std::vector<string>& mediaFileList) {
	mediaFileList.clear();
...
int Charge2Activity::removeCharFromString(string& nString, char c) {
