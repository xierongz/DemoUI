...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_STATUSBAR_sys_home, onButtonClick_sys_home,
    ID_STATUSBAR_SYS_BACK, onButtonClick_SYS_BACK,
};
/***************/
...
void statusbar::onCreate() {
    ...
    mTextWiFiPtr = (ZKTextView*)findControlByID(ID_STATUSBAR_TextWiFi);
    mTextTimePtr = (ZKTextView*)findControlByID(ID_STATUSBAR_TextTime);
    mSYS_BACKPtr = (ZKButton*)findControlByID(ID_STATUSBAR_SYS_BACK);
    mView_1Ptr = (ZKWindow*)findControlByID(ID_STATUSBAR_View_1);
        // 注册监听全局触摸
	onUI_init();
...
void statusbar::videoLoopPlayback(ZKVideoView *pVideoView, int msg, int callbackTabIndex) {
