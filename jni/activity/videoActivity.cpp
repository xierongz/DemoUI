...
static S_VideoViewCallback SVideoViewCallbackTab[] = {
    ID_VIDEO_Videoview1, true, 5, NULL,
};
...
void videoActivity::onCreate() {
	Activity::onCreate();
    mVideoview1Ptr = (ZKVideoView*)findControlByID(ID_VIDEO_Videoview1);if(mVideoview1Ptr!= NULL){mVideoview1Ptr->setVideoPlayerMessageListener(this);}
    mTextdirationPtr = (ZKTextView*)findControlByID(ID_VIDEO_Textdiration);
    mTextTipsPtr = (ZKTextView*)findControlByID(ID_VIDEO_TextTips);
    mTextWeekPtr = (ZKTextView*)findControlByID(ID_VIDEO_TextWeek);
    mTextDatePtr = (ZKTextView*)findControlByID(ID_VIDEO_TextDate);
    mDigitalclock1Ptr = (ZKDigitalClock*)findControlByID(ID_VIDEO_Digitalclock1);
    mTextfloatPtr = (ZKTextView*)findControlByID(ID_VIDEO_Textfloat);
...
void videoActivity::videoLoopPlayback(ZKVideoView *pVideoView, int msg, int callbackTabIndex) {
