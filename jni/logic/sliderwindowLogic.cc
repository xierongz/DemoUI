...
static void updateUI_time(){
	...
	if(std::string(timeStr)!= mTextTimePtr->getText()){
...
static bool onUI_Timer(int id){
    //Tips:添加定时器响应的代码到这里,但是需要先打开 activity/sliderwindowActivityActivity.cpp onCreate 函数里面的registerTmer
...
static bool onsliderwindowActivityTouchEvent(const MotionEvent &ev) {
